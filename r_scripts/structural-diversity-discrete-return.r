...
system("mkdir ~/data")
system("cd ~/data && wget -q https://data.cyverse.org/dav-anon/iplant/projects/NEON_workshop/data/NEON_D17_TEAK_DP1_316000_4091000_classified_point_cloud_colorized.laz")
system("cd ~/data && wget -q https://data.cyverse.org/dav-anon/iplant/projects/NEON_workshop/data/NEON_D01_HARV_DP1_727000_4702000_classified_point_cloud_colorized.laz")
